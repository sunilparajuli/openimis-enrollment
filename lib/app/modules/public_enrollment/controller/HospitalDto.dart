...
class PublicHospital implements IDto {
  bool? success;
  List<PublicHealthServiceProvider>? data;
  ...
  factory PublicHospital.fromJson(Map<String, dynamic> json) {
    return PublicHospital(
      success: json["success"],
      data: json["data"] != null
          ? List<PublicHealthServiceProvider>.from(json["data"].map((x) => PublicHealthServiceProvider.fromJson(x)))
          : null,
    );
  }
...
class PublicHealthServiceProvider implements IDto {
  int? id;
  dynamic jsonExt;
  ...
  factory PublicHealthServiceProvider.fromJson(Map<String, dynamic> json) {
    return PublicHealthServiceProvider(
      id: json["id"],
